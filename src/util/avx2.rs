//! The following code are adopted from Plonky2 with adaptions.
#![allow(dead_code)]
...
impl DivAssign<Goldilocks> for Avx2GoldilocksField {
    #[inline]
...
impl Avx2GoldilocksField {
    ...
    #[inline]
    pub(crate) fn from_slice(slice: &[Goldilocks]) -> &Self {
...
const SHIFTED_FIELD_ORDER: __m256i =
    unsafe { transmute([Avx2GoldilocksField::MODULUS ^ (i64::MIN as u64); 4]) };
const EPSILON: __m256i = unsafe { transmute([Avx2GoldilocksField::MODULUS.wrapping_neg(); 4]) };
...
mod tests {
    ...
    fn test_vals_a() -> [Goldilocks; 4] {
        [
            Goldilocks(14479013849828404771),
            Goldilocks(9087029921428221768),
            Goldilocks(2441288194761790662),
            Goldilocks(5646033492608483824),
        ]
    }
    fn test_vals_b() -> [Goldilocks; 4] {
        [
            Goldilocks(17891926589593242302),
            Goldilocks(11009798273260028228),
            Goldilocks(2028722748960791447),
            Goldilocks(7929433601095175579),
        ]
    }
    ...
    #[test]
    fn test_interleave() {
        let in_a: [Goldilocks; 4] = [
            Goldilocks(00),
            Goldilocks(01),
            Goldilocks(02),
            Goldilocks(03),
        ];
        let in_b: [Goldilocks; 4] = [
            Goldilocks(10),
            Goldilocks(11),
            Goldilocks(12),
            Goldilocks(13),
        ];
        let int1_a: [Goldilocks; 4] = [
            Goldilocks(00),
            Goldilocks(10),
            Goldilocks(02),
            Goldilocks(12),
        ];
        let int1_b: [Goldilocks; 4] = [
            Goldilocks(01),
            Goldilocks(11),
            Goldilocks(03),
            Goldilocks(13),
        ];
        let int2_a: [Goldilocks; 4] = [
            Goldilocks(00),
            Goldilocks(01),
            Goldilocks(10),
            Goldilocks(11),
        ];
        let int2_b: [Goldilocks; 4] = [
            Goldilocks(02),
            Goldilocks(03),
            Goldilocks(12),
            Goldilocks(13),
